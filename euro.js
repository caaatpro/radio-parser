          ...
          parseString(xml, function (err, result) {
            ...
            if (result.lfm.$.status == 'ok') {
              ...
              if (s != '') {
                ...
                download(s, 'imgeuro/'+filename, null);
                cover = filename;
              }
            }

            console.log(play_date, data.singer.toUpperCase(), data.song.toUpperCase(), cover, play_time, start_song);
...
function saveDate(play_date, artist_name, song_name, cover, play_time, start_song) {
  var sql = "INSERT INTO eurosongs (play_date, artist_name, song_name, cover, play_time, start_song, uid) VALUES ('"+play_date+"', '"+artist_name+"', '"+song_name+"', '"+cover+"', '"+play_time+"', '"+start_song+"', '')";
